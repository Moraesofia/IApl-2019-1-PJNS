...
public class ArquivoJnsSaver {
    ...
    private static String trailerArquivo(int tamReg, int numLote, int tipoReg, int qntLotesArq,
                                         int qntRegArq) {
    ...
    private static String headerLote(int tamReg, int numLote, int tipoReg, int tipolote,
                                     String versao) {
     ...
     * @return
     */
    private static String beginRegistro(int tamReg, int numLote, int tipoReg, int numReg,
    ...
    public static boolean validPessoa(Pessoa pe) {
        ...
        if (!validSize(pe.getNascimento(), 8)) {
            return false;
        }
    ...
    public void save(ArquivoJns dados, File file) {
        ...
        for (Pessoa pe : dados.getPessoas()) {
            if (!validPessoa(pe)) {
                ...
                String nascP = formatStr("8", pe.getNascimento());
