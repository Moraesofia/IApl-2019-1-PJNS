...
@ControllerAdvice
public class WebExceptionHandler extends org.springframework.web.servlet.mvc.method.annotation.ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpStatusCodeException(HttpStatusCodeException ex, HttpServletRequest request, WebRequest webRequest) {
        RespostaSimplesDto respostaSimplesDto = new RespostaSimplesDto(ex.getStatusCode(), request.getContextPath() + "/" + request.getServletPath(), ex.getMessage());
